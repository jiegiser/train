...
import org.jiegiser.train.business.feign.MemberFeign;
import org.jiegiser.train.business.mapper.ConfirmOrderMapper;
import org.jiegiser.train.business.mapper.DailyTrainSeatMapper;
import org.jiegiser.train.business.mapper.cust.DailyTrainTicketMapperCust;
...
public class AfterConfirmOrderService {
    ...
    public void afterDoConfirm(DailyTrainTicket dailyTrainTicket, List<DailyTrainSeat> finalSeatList, List<ConfirmOrderTicketReq> tickets, ConfirmOrder confirmOrder) throws Exception {
        ...
        for (int j = 0; j < finalSeatList.size(); j++) {
            ...
            LOG.info("调用 member 接口，返回：{}", commonResp);
